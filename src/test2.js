...
// const path = join('/home/centos/result_peakpicking/result_COV09090_302-1_40.json');
...
(async () => {
  ...
  const pathToWrite = '/home/centos/result_peakpicking_fit4';
  ...
  for (const goe of groupsOfExperiments) {
    ...
    await process({ xyData, name, pathToWrite })
  }
})()
...
function process(options) {
  const { xyData, name, pathToWrite } = options;
